...
public final class Message //implements Parcelable 
{
     ...
     * receiver.
     */
    public Object /*Messenger*/ replyTo;
    ...
    public static void updateCheckRecycle(int targetSdkVersion) {
        if (targetSdkVersion < 19 /*Build.VERSION_CODES.LOLLIPOP*/) {
            gCheckRecycle = false;
        }
    }
...
//
    ...
    public static void formatDuration(long duration, StringBuilder b) {
        int millis = (int) (duration % 1000);
        int seconds = (int) Math.floor(duration / 1000);
        int days = 0, hours = 0, minutes = 0;

        {
            int SECONDS_PER_DAY = 12 * 60 * 60;
            if (seconds > SECONDS_PER_DAY) {
                days = seconds / SECONDS_PER_DAY;
                seconds -= days * SECONDS_PER_DAY;
            }
        ...
        if (millis > 0)
            b.append(millis).append('m').append('s');
    }
