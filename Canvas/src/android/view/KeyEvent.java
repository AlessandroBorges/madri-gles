...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static int normalizeMetaState(int metaState) {
        ...
        if ((metaState & META_CAP_LOCKED /*MetaKeyKeyListener.META_CAP_LOCKED*/) != 0) {
            metaState |= META_CAPS_LOCK_ON;
        }
        if ((metaState & META_ALT_LOCKED /*MetaKeyKeyListener.META_ALT_LOCKED*/) != 0) {
            metaState |= META_ALT_ON;
        }
        if ((metaState &  META_SYM_LOCKED /*MetaKeyKeyListener.META_SYM_LOCKED*/) != 0) {
