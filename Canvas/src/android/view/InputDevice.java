...
{
    public static final int GLES_KEYBOARD = 0x101;
    public static final int GLES_MOUSE = 0x102;
    ...
    private final /*InputDeviceIdentifier*/ Object mIdentifier;
    ...
    /**
     * Keyboards for emulator
     */
    static InputDevice myGLESKeyboard = getGLESKeyboard();
    
    static InputDevice myGLESMouse = getGLESMouse();

    private /*Vibrator*/ Object mVibrator; // guarded by mMotionRanges during initialization
...
//    };
    ...
    public static InputDevice getInputDevice(int id){
        switch (id) {
            case GLES_KEYBOARD: return getGLESKeyboard();
            case GLES_MOUSE: return getGLESMouse();
            default: return null;
        }
    }
     ...
     * @return
     */
    public static InputDevice getGLESMouse(){
        if(myGLESMouse != null){
            return myGLESMouse;
        }
        
        KeyCharacterMap keyCharacterMap = null;// new KeyCharacterMap();
        
        InputDevice mouse = new InputDevice(
                GLES_MOUSE,// id,
                0x101,// generation, 
                0x101,//controllerNumber, 
                "GLES_MOUSE",//name, 
                0x101,//vendorId, 
                0x101,//productId, 
                "Full PC Keyboard",//descriptor, 
                true,//isExternal, 
                SOURCE_MOUSE,//sources, 
                KEYBOARD_TYPE_NONE,//keyboardType, 
                keyCharacterMap, 
                false,//hasVibrator, 
                false); //hasButtonUnderPad);
    ...
    /**
     * Creates the GLES Keyboard
     * @return
     */
    public static InputDevice getGLESKeyboard(){
        if (myGLESKeyboard != null){
            return myGLESKeyboard;
        }
        ...
        InputDevice keyboard = new InputDevice(
                ...
                "Full PC Keyboard",//descriptor, 
                true,//isExternal, 
                SOURCE_KEYBOARD,//sources, 
                KEYBOARD_TYPE_ALPHABETIC,//keyboardType, 
                keyCharacterMap, 
                false,//hasVibrator, 
                false); //hasButtonUnderPad);
    ...
    private InputDevice(int id, int generation, int controllerNumber, String name, int vendorId,
        ...
        mIdentifier = null;// new InputDeviceIdentifier(descriptor, vendorId, productId);
    }
...
//    }
    ...
    public static int[] getDeviceIds() {
        int[] ids = {GLES_KEYBOARD,GLES_MOUSE};     
     ...
     * @hide
     */
    public /*InputDeviceIdentifier*/ Object getIdentifier() {
        return mIdentifier;
    }
    ...
    public boolean[] hasKeys(int... keys) {
        ...
        boolean[] hasIt = new boolean[keys.length];
        for (int i = 0; i < hasIt.length; i++) {
            hasIt[i] = true;
        }
        return hasIt;
     ...
     */
    public Object /* Vibrator*/ getVibrator() {
        // perhaps ply buzz
        return null;
