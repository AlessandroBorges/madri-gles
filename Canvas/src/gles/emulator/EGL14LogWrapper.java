...
public class EGL14LogWrapper
    ...
    public EGL14LogWrapper(boolean logNames, boolean check_error, PrintStream log) {
        //Writer writer = new java.io.PrintWriter(log);
        this(logNames,check_error,new java.io.PrintWriter(log));
    }

    public EGL14LogWrapper(boolean logNames, boolean check_error, Writer log) {
        //mEgl14 = EGL14.;
        mLog = log;
        mLogArgumentNames = logNames;
                                   ...
                                   int[] num_config) 
    {
        ...
        boolean result = mEgl14.eglChooseConfig(display, 
                                                attrib_list, 0,
                                                configs, 0,
                                                config_size, 
                                                num_config,0);
    ...
    public boolean eglCopyBuffers(EGLDisplay display, EGLSurface surface, int native_pixmap) {
        ...
        boolean result = mEgl14.eglCopyBuffers(display, surface, native_pixmap);
        returns(result);
        checkError();
        return result;
    }
    ...
    public EGLContext eglCreateContext(EGLDisplay display, EGLConfig config,
        ...
        EGLContext result = mEgl14.eglCreateContext(display, 
                                                   config,
                                                   share_context,  
                                                   attrib_list,0);
        returns(result);
    ...
    public EGLSurface eglCreatePbufferSurface(EGLDisplay display,
        ...
        EGLSurface result = mEgl14.eglCreatePbufferSurface(display, 
                                                            config,
                                                            attrib_list,0);
        returns(result);
        checkError();
    ...
    public EGLSurface eglCreatePixmapSurface(EGLDisplay display,
        ...
        EGLSurface result = mEgl14.eglCreatePixmapSurface(display, 
                                                          config,
                                                          native_pixmap, 
                                                          attrib_list,0);
        returns(result);
    ...
    public EGLSurface eglCreateWindowSurface(EGLDisplay display,
        ...
        EGLSurface result = mEgl14.eglCreateWindowSurface(display, config,
                                                           native_window, 
                                                           attrib_list,0);
        returns(result);
        checkError();
    ...
    public boolean eglDestroyContext(EGLDisplay display, EGLContext context) {
        ...
        boolean result = mEgl14.eglDestroyContext(display, context);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglDestroySurface(EGLDisplay display, EGLSurface surface) {
        ...
        boolean result = mEgl14.eglDestroySurface(display, surface);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglGetConfigAttrib(EGLDisplay display, EGLConfig config,
        ...
        boolean result = mEgl14.eglGetConfigAttrib(display, 
                                                   config,
                                                   attribute,
                                                   value,0);
        arg("value", value);
    ...
    public boolean eglGetConfigs(EGLDisplay display, 
        ...
        boolean result = mEgl14.eglGetConfigs(display, 
                                              configs, 0, 
                                              config_size,
                                              num_config,0);
        arg("configs", configs);
    ...
    public Object eglGetCurrentContext() {
        begin("eglGetCurrentContext");
        end();

        EGLContext result = mEgl14.eglGetCurrentContext();
        returns(result);
    ...
    public EGLDisplay eglGetCurrentDisplay() {
        ...
        EGLDisplay result = mEgl14.eglGetCurrentDisplay();
        returns(result);
    ...
    public EGLSurface eglGetCurrentSurface(int readdraw) {
        ...
        EGLSurface result = mEgl14.eglGetCurrentSurface(readdraw);
        returns(result);
    ...
    public EGLDisplay eglGetDisplay(int native_display) {
        ...
        EGLDisplay result = mEgl14.eglGetDisplay(native_display);
        returns(result);
    ...
    public boolean eglInitialize(EGLDisplay display, 
        ...
        boolean result = mEgl14.eglInitialize(display, major, majorOffset, minor, minorOffset);
        returns(result);
        arg("major", major);
        arg("minor", minor);
        checkError();
    ...
    public boolean eglMakeCurrent(EGLDisplay display, EGLSurface draw,
        ...
        boolean result = mEgl14.eglMakeCurrent(display, draw, read, context);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglQueryContext(EGLDisplay display, EGLContext context,
        ...
        boolean result = mEgl14.eglQueryContext(display, context, attribute, value,0);
        returns(value[0]);
        returns(result);
        checkError();
        return result;
    ...
    public String eglQueryString(EGLDisplay display, int name) {
        ...
        String result = mEgl14.eglQueryString(display, name);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglQuerySurface(EGLDisplay display, 
        ...
        boolean result = mEgl14.eglQuerySurface(display, 
                                                surface, attribute,
                                                value,0);
        returns(value[0]);
        returns(result);
    ...
    public boolean eglReleaseThread() {
        ...
        boolean result = mEgl14.eglReleaseThread();
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglSwapBuffers(EGLDisplay display, EGLSurface surface) {
        ...
        boolean result = mEgl14.eglSwapBuffers(display, surface);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglTerminate(EGLDisplay display) {
        ...
        boolean result = mEgl14.eglTerminate(display);
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglWaitGL() {
        ...
        boolean result = mEgl14.eglWaitGL();
        returns(result);
        checkError();
        return result;
    }
    ...
    public boolean eglWaitNative(int engine, Object bindTarget) {
        ...
        boolean result = mEgl14.eglWaitNative(engine);
        returns(result);
        checkError();
        return result;
    }
    ...
    private void checkError() {
        int eglError;
        if ((eglError = mEgl14.eglGetError()) != EGL_SUCCESS) {
    ...
    private void arg(String name, EGLDisplay object) {
        ...
        if (object.getNativeHandle() == EGL14.EGL_DEFAULT_DISPLAY) {
            arg(name, "EGL14.EGL_DEFAULT_DISPLAY");
    ...
    private void arg(String name, EGLContext object) {
        if (object == EGL14.EGL_NO_CONTEXT) {
