...
public class GLES31Pipeline
   ...
   */
    ...
    */
     ...
     **/
    private static native void nGLGenProgramPipelines(int n, java.nio.IntBuffer pipelines, int offset);/*
      glGenProgramPipelines((GLsizei) n, (GLuint *)(pipelines + offset) );
    */
    ...
    */
     ...
     **/
    private static native void nGLGetProgramPipelineiv(int pipeline, 
                                                       int pname, 
                                                       int[] params, int offset);/*
    ...
    public void glGetProgramPipelineiv(int pipeline, int pname, java.nio.IntBuffer params) {
        int offset = getOffset(params);
        nGLGetProgramPipelineiv(pipeline, pname, params, offset);
    }
    ...
    */
     ...
     **/
    private static native void nGLProgramUniform4i(int program, 
                                                   int location, 
...
*/
    ...
    */
     ...
     **/
    private static native void nGLProgramUniform1uiv(int program, 
                                                     int location,
                                                     int count, 
     ...
     **/
    private static native void nGLProgramUniform2uiv(int program, 
                                                     int location, 
                                                     int count, 
                                                     int[] value, int offset);/*
...
*/
     ...
     **/
    private static native void nGLProgramUniform3uiv(int program, 
                                                     int location, 
                                                     int count, 
                                                     int[] value, 
                                                     int offset);/*
...
*/
    ...
    */
     ...
     * 
     *  C function void glProgramUniform4uiv((GLuint) program, 
     *                                         (GLint) location, 
     *                                         (GLsizei) count, 
     *                                         const (GLuint) *value );
     **/
    private static native void nGLProgramUniform4uiv(int program, 
                                                     int location, 
                                                     int count, 
                                                     java.nio.IntBuffer value, int offset);/*
      glProgramUniform4uiv((GLuint) program, 
...
*/
   ...
   */
    ...
    */
     ...
     **/
    private static native void nGLBindImageTexture(int unit, 
                                                   int texture, 
                                                   int level, 
                                                   boolean layered, 
                                                   int layer, 
    ...
    */
    ...
    public void glGetBooleani_v(int target, int index, boolean[] data, int offset) {
        GLES31Pipeline.nGLGetBooleaniv(target, index, data, offset);
    }
     ...
     **/
    private static native void nGLGetBooleaniv(int target, int index, boolean[] data, int offset);/*
    ...
    */
     ...
     **/
    private static native void nGLGetBooleaniv(int target, int index, 
...
*/
    ...
    */
     ...
     **/
    private static native void nGLTexStorage2DMultisample(int target,
                                                          int samples,
                                                          int internalformat,
                                                          int width,
                                                          int height,
   ...
   */
    ...
    */
     ...
     **/
    private static native void nGLGetTexLevelParameteriv(int target, 
                                                         int level, 
                                                         int pname, 
                                                         int[] params, int offset);/*
...
*/
    ...
    public void glGetTexLevelParameterfv(int target, int level, int pname, java.nio.FloatBuffer params) {
        int offset = getOffset(params);
        nGLGetTexLevelParameterfv(target, level, pname, params, offset);
    }
    ...
    */
     ...
     **/
    private static native void nGLVertexAttribFormat(int attribindex, 
                                                     int size, int type, 
                                                     boolean normalized, 
                                                     int relativeoffset);/*
